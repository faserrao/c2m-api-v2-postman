...
postman-api-full-publish:
	...
	@SPECS=$$(curl --silent $(POSTMAN_HEADER_API_KEY) \
		"$(POSTMAN_SPECS_URL)" \
		| tee $(SPECS_DEBUG_FILE) | jq -r '.data // [] | .[].id'); \
...
postman-cleanup-all:
	...
	# --- Delete Mock Servers ---
	@echo "🗑️ Fetching mock servers in workspace $(POSTMAN_WS)..."
	...
	# --- Delete APIs ---
	@echo "🗑️ Fetching APIs in workspace $(POSTMAN_WS)..."
	...
	# --- Delete Environments ---
	@echo "🗑️ Fetching environments in workspace $(POSTMAN_WS)..."
	...
	# --- Delete Specs ---
	@echo "🗑️ Fetching specs in workspace $(POSTMAN_WS)..."
