...
namespace C2M.Api.Model
{
    ...
    public partial class SubmitMultiDocParams : IValidatableObject
    {
        ...
        [JsonConstructor]
        public SubmitMultiDocParams(List<SubmitMultiDocWithTemplateParamsRequestItemsInner> items, JobOptions jobOptions, Option<PaymentDetails?> paymentDetails = default, Option<List<string>?> tags = default)
        {
            Items = items;
    ...
    public class SubmitMultiDocParamsJsonConverter : JsonConverter<SubmitMultiDocParams>
    {
        ...
        public override SubmitMultiDocParams Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new SubmitMultiDocParams(items.Value!, jobOptions.Value!, paymentDetails, tags);
        }
