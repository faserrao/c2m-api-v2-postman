...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new C2MApiV2AuthOverlay.InvoiceDetails();
  });
  ...
  describe('InvoiceDetails', function() {
    it('should create an instance of InvoiceDetails', function() {
      ...
      //var instance = new C2MApiV2AuthOverlay.InvoiceDetails();
      //expect(instance).to.be.a(C2MApiV2AuthOverlay.InvoiceDetails);
    });
