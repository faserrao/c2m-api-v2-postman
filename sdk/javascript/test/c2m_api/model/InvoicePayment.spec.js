...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new C2MApiV2AuthOverlay.InvoicePayment();
  });
  ...
  describe('InvoicePayment', function() {
    it('should create an instance of InvoicePayment', function() {
      ...
      //var instance = new C2MApiV2AuthOverlay.InvoicePayment();
      //expect(instance).to.be.a(C2MApiV2AuthOverlay.InvoicePayment);
    });
