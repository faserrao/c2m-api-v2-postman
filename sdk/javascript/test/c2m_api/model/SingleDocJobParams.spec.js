...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new C2MApiV2AuthOverlay.SingleDocJobParams();
  });
  ...
  describe('SingleDocJobParams', function() {
    it('should create an instance of SingleDocJobParams', function() {
      // uncomment below and update the code to test SingleDocJobParams
      //var instance = new C2MApiV2AuthOverlay.SingleDocJobParams();
      //expect(instance).to.be.a(C2MApiV2AuthOverlay.SingleDocJobParams);
    });
