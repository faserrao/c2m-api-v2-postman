...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new C2MApiV2AuthOverlay.ApplePayPayment();
  });
  ...
  describe('ApplePayPayment', function() {
    it('should create an instance of ApplePayPayment', function() {
      // uncomment below and update the code to test ApplePayPayment
      //var instance = new C2MApiV2AuthOverlay.ApplePayPayment();
      //expect(instance).to.be.a(C2MApiV2AuthOverlay.ApplePayPayment);
    });
