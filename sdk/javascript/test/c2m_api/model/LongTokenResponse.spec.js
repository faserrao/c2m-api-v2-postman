...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new C2MApiV2AuthOverlay.LongTokenResponse();
  });
  ...
  describe('LongTokenResponse', function() {
    it('should create an instance of LongTokenResponse', function() {
      ...
      //var instance = new C2MApiV2AuthOverlay.LongTokenResponse();
      //expect(instance).to.be.a(C2MApiV2AuthOverlay.LongTokenResponse);
    });
