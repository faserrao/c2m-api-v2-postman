...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new C2MApiV2AuthOverlay.SplitPdfWithCaptureParams();
  });
  ...
  describe('SplitPdfWithCaptureParams', function() {
    it('should create an instance of SplitPdfWithCaptureParams', function() {
      // uncomment below and update the code to test SplitPdfWithCaptureParams
      //var instance = new C2MApiV2AuthOverlay.SplitPdfWithCaptureParams();
      //expect(instance).to.be.a(C2MApiV2AuthOverlay.SplitPdfWithCaptureParams);
    });
