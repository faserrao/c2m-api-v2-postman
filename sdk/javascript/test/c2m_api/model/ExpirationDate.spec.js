...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new C2MApiV2AuthOverlay.ExpirationDate();
  });
  ...
  describe('ExpirationDate', function() {
    it('should create an instance of ExpirationDate', function() {
      ...
      //var instance = new C2MApiV2AuthOverlay.ExpirationDate();
      //expect(instance).to.be.a(C2MApiV2AuthOverlay.ExpirationDate);
    });
