...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new C2MApiV2AuthOverlay.SplitPdfParamsRequest();
  });
  ...
  describe('SplitPdfParamsRequest', function() {
    it('should create an instance of SplitPdfParamsRequest', function() {
      // uncomment below and update the code to test SplitPdfParamsRequest
      //var instance = new C2MApiV2AuthOverlay.SplitPdfParamsRequest();
      //expect(instance).to.be.a(C2MApiV2AuthOverlay.SplitPdfParamsRequest);
    });
