...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new C2MApiV2AuthOverlay.ExtractionSpec();
  });
  ...
  describe('ExtractionSpec', function() {
    it('should create an instance of ExtractionSpec', function() {
      // uncomment below and update the code to test ExtractionSpec
      //var instance = new C2MApiV2AuthOverlay.ExtractionSpec();
      //expect(instance).to.be.a(C2MApiV2AuthOverlay.ExtractionSpec);
    });
