...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new C2MApiV2AuthOverlay.SubmitMultiDocParamsRequest();
  });
  ...
  describe('SubmitMultiDocParamsRequest', function() {
    it('should create an instance of SubmitMultiDocParamsRequest', function() {
      // uncomment below and update the code to test SubmitMultiDocParamsRequest
      //var instance = new C2MApiV2AuthOverlay.SubmitMultiDocParamsRequest();
      //expect(instance).to.be.a(C2MApiV2AuthOverlay.SubmitMultiDocParamsRequest);
    });
