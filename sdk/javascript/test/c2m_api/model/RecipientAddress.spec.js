...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new C2MApiV2AuthOverlay.RecipientAddress();
  });
  ...
  describe('RecipientAddress', function() {
    it('should create an instance of RecipientAddress', function() {
      // uncomment below and update the code to test RecipientAddress
      //var instance = new C2MApiV2AuthOverlay.RecipientAddress();
      //expect(instance).to.be.a(C2MApiV2AuthOverlay.RecipientAddress);
    });
