...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new C2MApiV2AuthOverlay.GooglePayPayment();
  });
  ...
  describe('GooglePayPayment', function() {
    it('should create an instance of GooglePayPayment', function() {
      // uncomment below and update the code to test GooglePayPayment
      //var instance = new C2MApiV2AuthOverlay.GooglePayPayment();
      //expect(instance).to.be.a(C2MApiV2AuthOverlay.GooglePayPayment);
    });
