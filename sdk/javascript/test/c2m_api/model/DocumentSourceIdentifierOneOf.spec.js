...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new C2MApiV2AuthOverlay.DocumentSourceIdentifierOneOf();
  });
  ...
  describe('DocumentSourceIdentifierOneOf', function() {
    it('should create an instance of DocumentSourceIdentifierOneOf', function() {
      // uncomment below and update the code to test DocumentSourceIdentifierOneOf
      //var instance = new C2MApiV2AuthOverlay.DocumentSourceIdentifierOneOf();
      //expect(instance).to.be.a(C2MApiV2AuthOverlay.DocumentSourceIdentifierOneOf);
    });
