...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new C2MApiV2AuthOverlay.SubmitMultiDocWithTemplateParamsRequestItemsInner();
  });
  ...
  describe('SubmitMultiDocWithTemplateParamsRequestItemsInner', function() {
    it('should create an instance of SubmitMultiDocWithTemplateParamsRequestItemsInner', function() {
      // uncomment below and update the code to test SubmitMultiDocWithTemplateParamsRequestItemsInner
      //var instance = new C2MApiV2AuthOverlay.SubmitMultiDocWithTemplateParamsRequestItemsInner();
      //expect(instance).to.be.a(C2MApiV2AuthOverlay.SubmitMultiDocWithTemplateParamsRequestItemsInner);
    });
