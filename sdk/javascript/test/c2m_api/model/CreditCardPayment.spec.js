...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new C2MApiV2AuthOverlay.CreditCardPayment();
  });
  ...
  describe('CreditCardPayment', function() {
    it('should create an instance of CreditCardPayment', function() {
      ...
      //var instance = new C2MApiV2AuthOverlay.CreditCardPayment();
      //expect(instance).to.be.a(C2MApiV2AuthOverlay.CreditCardPayment);
    });
