...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new C2MApiV2AuthOverlay.SubmitMultiDocWithTemplateParams();
  });
  ...
  describe('SubmitMultiDocWithTemplateParams', function() {
    it('should create an instance of SubmitMultiDocWithTemplateParams', function() {
      // uncomment below and update the code to test SubmitMultiDocWithTemplateParams
      //var instance = new C2MApiV2AuthOverlay.SubmitMultiDocWithTemplateParams();
      //expect(instance).to.be.a(C2MApiV2AuthOverlay.SubmitMultiDocWithTemplateParams);
    });
