...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new C2MApiV2AuthOverlay.SubmitMultiDocWithTemplateParamsRequest();
  });
  ...
  describe('SubmitMultiDocWithTemplateParamsRequest', function() {
    it('should create an instance of SubmitMultiDocWithTemplateParamsRequest', function() {
      // uncomment below and update the code to test SubmitMultiDocWithTemplateParamsRequest
      //var instance = new C2MApiV2AuthOverlay.SubmitMultiDocWithTemplateParamsRequest();
      //expect(instance).to.be.a(C2MApiV2AuthOverlay.SubmitMultiDocWithTemplateParamsRequest);
    });
