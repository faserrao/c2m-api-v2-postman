...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new C2MApiV2AuthOverlay.SingleDocJobParamsRequest();
  });
  ...
  describe('SingleDocJobParamsRequest', function() {
    it('should create an instance of SingleDocJobParamsRequest', function() {
      // uncomment below and update the code to test SingleDocJobParamsRequest
      //var instance = new C2MApiV2AuthOverlay.SingleDocJobParamsRequest();
      //expect(instance).to.be.a(C2MApiV2AuthOverlay.SingleDocJobParamsRequest);
    });
