...
(function(root, factory) {
  ...
  describe('Digit', function() {
    it('should create an instance of Digit', function() {
      // uncomment below and update the code to test Digit
      //var instance = new C2MApiV2AuthOverlay.Digit();
      //expect(instance).to.be.a(C2MApiV2AuthOverlay.Digit);
    });
