...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new C2MApiV2AuthOverlay.SplitPdfParams();
  });
  ...
  describe('SplitPdfParams', function() {
    it('should create an instance of SplitPdfParams', function() {
      // uncomment below and update the code to test SplitPdfParams
      //var instance = new C2MApiV2AuthOverlay.SplitPdfParams();
      //expect(instance).to.be.a(C2MApiV2AuthOverlay.SplitPdfParams);
    });
