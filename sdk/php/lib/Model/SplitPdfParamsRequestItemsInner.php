...
/**
 * SplitPdfParamsRequestItemsInner Class Doc Comment
 *
 * @category Class
 * @package  C2MApi
 * @author   OpenAPI Generator team
 ...
 */
class SplitPdfParamsRequestItemsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'splitPdfParams_request_items_inner';
    ...
    protected static $openAPITypes = [
        'page_range' => '\C2MApi\Model\PageRange',
    ...
    {
        $this->setIfExists('page_range', $data ?? [], null);
    ...
    */
     ...
     * Sets page_range
     *
     * @param \C2MApi\Model\PageRange $page_range page_range
     *
     * @return self
     */
    public function setPageRange($page_range)
    {
        if (is_null($page_range)) {
            throw new \InvalidArgumentException('non-nullable page_range cannot be null');
        }
