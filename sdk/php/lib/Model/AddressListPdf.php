...
/**
 * AddressListPdf Class Doc Comment
 *
 * @category Class
 * @package  C2MApi
 * @author   OpenAPI Generator team
 ...
 */
class AddressListPdf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'addressListPdf';
    ...
    protected static $setters = [
        ...
        'address_list_region' => 'setAddressListRegion',
    ...
    protected static $getters = [
        ...
        'address_list_region' => 'getAddressListRegion',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('address_list_region', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['address_list_region'] === null) {
            $invalidProperties[] = "'address_list_region' can't be null";
        }
    ...
    /**
     * Gets address_list_region
     *
     * @return string
     */
    public function getAddressListRegion()
    {
        return $this->container['address_list_region'];
    }

    /**
     * Sets address_list_region
     *
     * @param string $address_list_region address_list_region
     *
     * @return self
     */
    public function setAddressListRegion($address_list_region)
    {
        if (is_null($address_list_region)) {
            throw new \InvalidArgumentException('non-nullable address_list_region cannot be null');
        }
        $this->container['address_list_region'] = $address_list_region;
