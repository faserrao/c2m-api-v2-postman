...
pub struct SubmitSingleDocWithTemplateParamsRequest {
...
impl SubmitSingleDocWithTemplateParamsRequest {
    pub fn new(job_template: String) -> SubmitSingleDocWithTemplateParamsRequest {
