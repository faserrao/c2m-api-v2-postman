...
pub struct SubmitMultiDocWithTemplateParams {
    #[serde(rename = "items")]
...
impl SubmitMultiDocWithTemplateParams {
    pub fn new(items: Vec<models::SubmitMultiDocWithTemplateParamsRequestItemsInner>, job_template: String, payment_details: models::PaymentDetails) -> SubmitMultiDocWithTemplateParams {
