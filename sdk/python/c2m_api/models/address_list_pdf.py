...
class AddressListPdf(BaseModel):
    """
    AddressListPdf
    """ # noqa: E501
    document_source_identifier: DocumentSourceIdentifier = Field(alias="documentSourceIdentifier")
    address_list_region: StrictStr = Field(alias="addressListRegion")
    delimiter: Optional[StrictStr] = None
    tags: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["documentSourceIdentifier", "addressListRegion", "delimiter", "tags"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "addressListRegion": obj.get("addressListRegion"),
